...
export async function deprecatedTestWithHttpInfo(
    ...
    const requestFactory = new QueryApiRequestFactory(configuration);
    const responseProcessor = new QueryApiResponseProcessor();

    const requestContext = await requestFactory.deprecatedTest(name);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.deprecatedTestWithHttpInfo(response);
}
...
export async function testEnumRefStringWithHttpInfo(
    ...
    const requestContext = await requestFactory.testEnumRefString(enumNonrefStringQuery, enumRefStringQuery);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testEnumRefStringWithHttpInfo(response);
}
...
export async function testQueryDatetimeDateStringWithHttpInfo(
    ...
    const requestContext = await requestFactory.testQueryDatetimeDateString(datetimeQuery, dateQuery, stringQuery);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testQueryDatetimeDateStringWithHttpInfo(response);
}
...
export async function testQueryIntegerBooleanStringWithHttpInfo(
    ...
    const requestContext = await requestFactory.testQueryIntegerBooleanString(integerQuery, booleanQuery, stringQuery);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testQueryIntegerBooleanStringWithHttpInfo(response);
}
...
export async function testQueryStyleDeepObjectExplodeTrueObjectWithHttpInfo(
    ...
    const requestContext = await requestFactory.testQueryStyleDeepObjectExplodeTrueObject(queryObject);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testQueryStyleDeepObjectExplodeTrueObjectWithHttpInfo(response);
}
...
export async function testQueryStyleDeepObjectExplodeTrueObjectAllOfWithHttpInfo(
    ...
    const requestContext = await requestFactory.testQueryStyleDeepObjectExplodeTrueObjectAllOf(queryObject);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testQueryStyleDeepObjectExplodeTrueObjectAllOfWithHttpInfo(response);
}
...
export async function testQueryStyleFormExplodeFalseArrayIntegerWithHttpInfo(
    ...
    const requestContext = await requestFactory.testQueryStyleFormExplodeFalseArrayInteger(queryObject);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testQueryStyleFormExplodeFalseArrayIntegerWithHttpInfo(response);
}
...
export async function testQueryStyleFormExplodeFalseArrayStringWithHttpInfo(
    ...
    const requestContext = await requestFactory.testQueryStyleFormExplodeFalseArrayString(queryObject);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testQueryStyleFormExplodeFalseArrayStringWithHttpInfo(response);
}
...
export async function testQueryStyleFormExplodeTrueArrayStringWithHttpInfo(
    ...
    const requestContext = await requestFactory.testQueryStyleFormExplodeTrueArrayString(queryObject);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testQueryStyleFormExplodeTrueArrayStringWithHttpInfo(response);
}
...
export async function testQueryStyleFormExplodeTrueObjectWithHttpInfo(
    ...
    const requestContext = await requestFactory.testQueryStyleFormExplodeTrueObject(queryObject);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testQueryStyleFormExplodeTrueObjectWithHttpInfo(response);
}
...
export async function testQueryStyleFormExplodeTrueObjectAllOfWithHttpInfo(
    ...
    const requestContext = await requestFactory.testQueryStyleFormExplodeTrueObjectAllOf(queryObject);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testQueryStyleFormExplodeTrueObjectAllOfWithHttpInfo(response);
}
