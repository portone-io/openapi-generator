...
*/
async function testsPathStringPathStringIntegerPathIntegerEnumNonrefStringPathEnumRefStringPathRequestProcessor(options: Configuration,pathString: string, pathInteger: number, enumNonrefStringPath: 'success' | 'failure' | 'unclassified', enumRefStringPath: StringEnumRef, ): Promise<RequestContext> {
    let _config = options;
...
*/
async function testsPathStringPathStringIntegerPathIntegerEnumNonrefStringPathEnumRefStringPathWithHttpInfoResponseProcessor(response: ResponseContext): Promise<HttpInfo<string >> {
 ...
 * @param enumRefStringPath 
 */
export async function testsPathStringPathStringIntegerPathIntegerEnumNonrefStringPathEnumRefStringPathWithHttpInfo(
    ...
    const requestContext = await testsPathStringPathStringIntegerPathIntegerEnumNonrefStringPathEnumRefStringPathRequestProcessor(configuration,pathString, pathInteger, enumNonrefStringPath, enumRefStringPath);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await testsPathStringPathStringIntegerPathIntegerEnumNonrefStringPathEnumRefStringPathWithHttpInfoResponseProcessor(response);
}
 ...
 * @param enumRefStringPath 
 */
export async function testsPathStringPathStringIntegerPathIntegerEnumNonrefStringPathEnumRefStringPath(
    configuration: Configuration,
    pathString: string,
    pathInteger: number,
    enumNonrefStringPath: 'success' | 'failure' | 'unclassified',
    ...
    const httpInfo = await testsPathStringPathStringIntegerPathIntegerEnumNonrefStringPathEnumRefStringPathWithHttpInfo(configuration, pathString, pathInteger, enumNonrefStringPath, enumRefStringPath);
