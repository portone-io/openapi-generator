...
export async function testsPathStringPathStringIntegerPathIntegerEnumNonrefStringPathEnumRefStringPathWithHttpInfo(
    ...
    const requestFactory = new PathApiRequestFactory(configuration);
    const responseProcessor = new PathApiResponseProcessor();

    const requestContext = await requestFactory.testsPathStringPathStringIntegerPathIntegerEnumNonrefStringPathEnumRefStringPath(pathString, pathInteger, enumNonrefStringPath, enumRefStringPath);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testsPathStringPathStringIntegerPathIntegerEnumNonrefStringPathEnumRefStringPathWithHttpInfo(response);
}
