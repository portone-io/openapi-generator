...
export async function testFormIntegerBooleanStringWithHttpInfo(
    ...
    const requestFactory = new FormApiRequestFactory(configuration);
    const responseProcessor = new FormApiResponseProcessor();

    const requestContext = await requestFactory.testFormIntegerBooleanString(integerForm, booleanForm, stringForm);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testFormIntegerBooleanStringWithHttpInfo(response);
}
...
export async function testFormObjectMultipartWithHttpInfo(
    ...
    const requestContext = await requestFactory.testFormObjectMultipart(marker);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testFormObjectMultipartWithHttpInfo(response);
}
...
export async function testFormOneofWithHttpInfo(
    ...
    const requestContext = await requestFactory.testFormOneof(form1, form2, form3, form4, id, name);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testFormOneofWithHttpInfo(response);
}
