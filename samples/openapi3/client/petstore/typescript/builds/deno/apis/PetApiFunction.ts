...
*/
async function addPetWithHttpInfoResponseProcessor(response: ResponseContext): Promise<HttpInfo<Pet >> {
...
*/
async function findPetsByTagsRequestProcessor(options: Configuration,tags: Array<string>, ): Promise<RequestContext> {
    let _config = options;
...
* @throws ApiException if the response code was not in [200, 299]
*/
async function findPetsByTagsWithHttpInfoResponseProcessor(response: ResponseContext): Promise<HttpInfo<Array<Pet> >> {
const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
if (isCodeInRange("200", response.httpStatusCode)) {
const body: Array<Pet> = ObjectSerializer.deserialize(
    ObjectSerializer.parse(await response.body.text(), contentType),
...
* @throws ApiException if the response code was not in [200, 299]
*/
async function updatePetWithHttpInfoResponseProcessor(response: ResponseContext): Promise<HttpInfo<Pet >> {
const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
if (isCodeInRange("200", response.httpStatusCode)) {
const body: Pet = ObjectSerializer.deserialize(
    ObjectSerializer.parse(await response.body.text(), contentType),
