...
export async function fakeBigDecimalMapWithHttpInfo(
    ...
    const requestFactory = new FakeApiRequestFactory(configuration);
    const responseProcessor = new FakeApiResponseProcessor();

    const requestContext = await requestFactory.fakeBigDecimalMap();
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.fakeBigDecimalMapWithHttpInfo(response);
}
...
export async function fakeHealthGetWithHttpInfo(
    ...
    const requestContext = await requestFactory.fakeHealthGet();
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.fakeHealthGetWithHttpInfo(response);
}
...
export async function fakeHttpSignatureTestWithHttpInfo(
    ...
    const requestContext = await requestFactory.fakeHttpSignatureTest(pet, query1, header1);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.fakeHttpSignatureTestWithHttpInfo(response);
}
...
export async function fakeOuterBooleanSerializeWithHttpInfo(
    ...
    const requestContext = await requestFactory.fakeOuterBooleanSerialize(body);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.fakeOuterBooleanSerializeWithHttpInfo(response);
}
...
export async function fakeOuterCompositeSerializeWithHttpInfo(
    ...
    const requestContext = await requestFactory.fakeOuterCompositeSerialize(outerComposite);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.fakeOuterCompositeSerializeWithHttpInfo(response);
}
...
export async function fakeOuterNumberSerializeWithHttpInfo(
    ...
    const requestContext = await requestFactory.fakeOuterNumberSerialize(body);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.fakeOuterNumberSerializeWithHttpInfo(response);
}
...
export async function fakeOuterStringSerializeWithHttpInfo(
    ...
    const requestContext = await requestFactory.fakeOuterStringSerialize(body);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.fakeOuterStringSerializeWithHttpInfo(response);
}
...
export async function fakePropertyEnumIntegerSerializeWithHttpInfo(
    ...
    const requestContext = await requestFactory.fakePropertyEnumIntegerSerialize(outerObjectWithEnumProperty);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.fakePropertyEnumIntegerSerializeWithHttpInfo(response);
}
...
export async function testBodyWithBinaryWithHttpInfo(
    ...
    const requestContext = await requestFactory.testBodyWithBinary(body);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testBodyWithBinaryWithHttpInfo(response);
}
...
export async function testBodyWithFileSchemaWithHttpInfo(
    ...
    const requestContext = await requestFactory.testBodyWithFileSchema(fileSchemaTestClass);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testBodyWithFileSchemaWithHttpInfo(response);
}
...
export async function testBodyWithQueryParamsWithHttpInfo(
    ...
    const requestContext = await requestFactory.testBodyWithQueryParams(query, user);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testBodyWithQueryParamsWithHttpInfo(response);
}
...
export async function testClientModelWithHttpInfo(
    ...
    const requestContext = await requestFactory.testClientModel(client);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testClientModelWithHttpInfo(response);
}
...
export async function testEndpointParametersWithHttpInfo(
    ...
    const requestContext = await requestFactory.testEndpointParameters(number, _double, patternWithoutDelimiter, _byte, integer, int32, int64, _float, string, binary, date, dateTime, password, callback);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testEndpointParametersWithHttpInfo(response);
}
...
export async function testEnumParametersWithHttpInfo(
    ...
    const requestContext = await requestFactory.testEnumParameters(enumHeaderStringArray, enumHeaderString, enumQueryStringArray, enumQueryString, enumQueryInteger, enumQueryDouble, enumQueryModelArray, enumFormStringArray, enumFormString);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testEnumParametersWithHttpInfo(response);
}
...
export async function testGroupParametersWithHttpInfo(
    ...
    const requestContext = await requestFactory.testGroupParameters(requiredStringGroup, requiredBooleanGroup, requiredInt64Group, stringGroup, booleanGroup, int64Group);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testGroupParametersWithHttpInfo(response);
}
...
export async function testInlineAdditionalPropertiesWithHttpInfo(
    ...
    const requestContext = await requestFactory.testInlineAdditionalProperties(requestBody);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testInlineAdditionalPropertiesWithHttpInfo(response);
}
...
export async function testJsonFormDataWithHttpInfo(
    ...
    const requestContext = await requestFactory.testJsonFormData(param, param2);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testJsonFormDataWithHttpInfo(response);
}
...
export async function testQueryParameterCollectionFormatWithHttpInfo(
    ...
    const requestContext = await requestFactory.testQueryParameterCollectionFormat(pipe, ioutil, http, url, context, allowEmpty, language);
    const response = await configuration.httpApi.send(requestContext).toPromise();

    return await responseProcessor.testQueryParameterCollectionFormatWithHttpInfo(response);
}
